...
import pytest
from sealman.constants import LAN_EDGE_TEMPLATE_VERSIONS
from sealman.routers.smart_ems.routes.post_smart_ems_config_nat import post_smart_ems_config_nat
from sealman.exceptions import SEMSError, UnmatchedDependency
from sealman.routers.smart_ems.schemas import NatConfig, NatRule
