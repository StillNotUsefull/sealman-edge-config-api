from sealman.authorization import resource_types as Resource
from sealman.authorization.permission_check import PathParamPermissionCheck
from sealman.authorization.permission_types import Device
from fastapi import Depends

from sealman.db.repos.password_renewal_task import PasswordRenewalTaskRepository
from sealman.db.session import get_repository
from sealman.routers.base_api_router import BaseAPIRouter

from sealman.routers.smart_ems.routes.get_smart_ems_device_info import get_smart_ems_device_info as _get_smart_ems_device_info
from sealman.routers.smart_ems.routes.get_smart_ems_firmware_status import get_smart_ems_firmware_status as _get_smart_ems_firmware_status
from sealman.routers.smart_ems.routes.post_smart_ems_update_lan import post_smart_ems_update_lan as _post_smart_ems_update_lan
from sealman.routers.smart_ems.routes.get_smart_ems_lan import get_smart_ems_lan as _get_smart_ems_lan
from sealman.routers.smart_ems.routes.post_smart_ems_config_cellular import post_smart_ems_config_cellular as _post_smart_ems_config_cellular
from sealman.routers.smart_ems.routes.get_smart_ems_config_cellular import get_smart_ems_config_cellular as _get_smart_ems_config_cellular
from sealman.routers.smart_ems.routes.get_smart_ems_device_config import get_smart_ems_device_config as _get_smart_ems_device_config
from sealman.routers.smart_ems.routes.post_smart_ems_config_nat import post_smart_ems_config_nat as _post_smart_ems_config_nat
from sealman.routers.smart_ems.routes.get_smart_ems_config_nat import get_smart_ems_config_nat as _get_smart_ems_config_nat
from sealman.routers.smart_ems.routes.get_smart_ems_secret_info import get_smart_ems_secret_info as _get_smart_ems_secret_info
from sealman.routers.smart_ems.routes.post_smart_ems_device_secret_request import post_smart_ems_device_secret_request as _post_smart_ems_device_secret_request
from sealman.routers.smart_ems.routes.post_smart_ems_device_secret_renew import post_smart_ems_device_secret_renew as _post_smart_ems_device_secret_renew
from sealman.routers.smart_ems.routes.get_smart_ems_default_template import get_smart_ems_default_template as _get_smart_ems_default_template
from sealman.routers.smart_ems.routes.post_smart_ems_apply_default_template import post_smart_ems_apply_default_template as _post_smart_ems_apply_default_template
from sealman.routers.smart_ems.schemas import (DeviceSecretInformation, DeviceSecretValue, SemsInfo2, SemsFirmwareStatus,
...
from sealman.routers.smart_ems.routes.post_smart_ems_config_portforwarding import post_smart_ems_config_portforwarding
from sealman.routers.smart_ems.routes.get_smart_ems_config_portforwarding import get_smart_ems_config_portforwarding
from sealman.routers.smart_ems.schemas import PortForwardingConfig
