from sealman.async_requests import get_async, put_async, delete_async
import logging
from sealman.smart_ems import SmartEMS
from sealman.exceptions import APIError, IoTBackendAPIError
from sealman.db.repos.device import DeviceRepository
import asyncio
from sealman.smart_ems import generate_resp_from_device_info
from sealman.routers.devices.routes.get_devices import populate_cache_from_iot_hub_query
from sealman.constants import IOT_HUB_NAME, SEMS_DEVICE_TEMPLATE_VARIABLES, BOOTSTRAP_SEMS_TEMPLATE_NAME
from sealman.helper import get_iothub_auth_headers
from sealman.routers.general.routes.put_deployment_tag import put_deployment_tag
