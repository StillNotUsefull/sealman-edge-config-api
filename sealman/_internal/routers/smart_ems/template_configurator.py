...
from sealman._internal.routers.smart_ems.schemas import ApplyDefaultTemplateResult
from sealman._internal.exceptions import SEMSFirmwareError, SEMSTemplateError
