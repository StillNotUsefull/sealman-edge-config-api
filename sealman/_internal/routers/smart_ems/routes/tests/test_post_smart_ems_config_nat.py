...
import pytest
from sealman._internal.constants import LAN_EDGE_TEMPLATE_VERSIONS
from sealman._internal.routers.smart_ems.routes.post_smart_ems_config_nat import post_smart_ems_config_nat
from sealman._internal.exceptions import SEMSError, UnmatchedDependency
from sealman._internal.routers.smart_ems.schemas import NatConfig, NatRule
