...
package = sealman._internal.db.models
for _, module_name, _ in pkgutil.iter_modules(package.__path__):
    importlib.import_module(f"sealman._internal.db.models.{module_name}")

# Allow consumer projects to register additional models with Base so they
# appear in autogenerated migrations.
# Set SEALMAN_MODELS=myapp.models,myapp.other_models in the environment.
import os
for module_path in filter(None, os.environ.get("SEALMAN_MODELS", "").split(",")):
    importlib.import_module(module_path.strip())
